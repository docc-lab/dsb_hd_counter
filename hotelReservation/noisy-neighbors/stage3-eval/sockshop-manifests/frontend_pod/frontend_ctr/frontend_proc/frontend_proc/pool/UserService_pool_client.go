...
//
// It provides funcs for instantiating the UserService_PoolClient namespace.
//
// To instantiate the UserService_PoolClient namespace, first call [New_UserService_PoolClient] and then either call 
...
// Initializes the UserService_PoolClient namespace by defining all of the nodes that run
...
func New_UserService_PoolClient(name string) *golang.NamespaceBuilder {
	b := golang.NewNamespaceBuilder(name)
	set_UserService_PoolClient_Args(b)
	set_UserService_PoolClient_Instances(b)
	set_UserService_PoolClient_Definitions(b)
	return b
}

// UserService_PoolClient requires that its arguments are either:
...
func set_UserService_PoolClient_Args(b *golang.NamespaceBuilder) {
}

// When the UserService_PoolClient namespace is built it will automatically instantiate
// the following nodes:
func set_UserService_PoolClient_Instances(b *golang.NamespaceBuilder) {
}

// The UserService_PoolClient namespace contains definitions for instantiating
// the following nodes:
//   user_service.client.ot
//   user_service.grpc_client
//   zipkin.client
func set_UserService_PoolClient_Definitions(b *golang.NamespaceBuilder) {
